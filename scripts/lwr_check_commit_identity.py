...
Usage:
    python scripts/lwr_check_commit_identity.py [--base <ref>] [--head <ref>]
...
Stdlib only. Exits 0 and prints "lwr-commit-identity check passed" on
...
def main() -> int:
    ...
    if findings:
        ...
        return 1
    print("lwr-commit-identity check passed")
    return 0
