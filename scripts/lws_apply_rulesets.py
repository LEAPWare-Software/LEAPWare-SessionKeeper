...
Usage:
    python scripts/lws_apply_rulesets.py                 # apply every ruleset
    python scripts/lws_apply_rulesets.py --dry-run        # print the JSON, do nothing
    python scripts/lws_apply_rulesets.py --repo OWNER/REPO --dry-run
...
LEAPWare-SessionKeeper's own first apply (LWS-D0): the fix is to run the repo
...
DEFAULT_REPO = "LEAPWare-Software/LEAPWare-SessionKeeper"
