...
Mirrors `plugins/claude/lws/bin/lws_hook.py` exactly, swapping the Claude
...
lives in lws_core or adapters/codex/hook_io.py, both under vendor/ next to
this file (populated by scripts/lws_build.py).
"""
...
def _resolve_policy_path() -> Path:
    ...
    Reads `LWS_POLICY_PATH` if set (for tests and advanced setups) and
